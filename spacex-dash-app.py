...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Success for Launch Site')
        return fig
    else:
        pie_df = spacex_df[spacex_df['Launch Site']==entered_site].groupby('class')['Launch Site'].count().reset_index()
...
def get_scatter_chart(entered_site,slider_values):
    ...
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)']<slider_values[1]]
    if entered_site == 'ALL':
